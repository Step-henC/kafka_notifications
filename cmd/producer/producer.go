...
//to strart run go run cmd/producer/producer.go from root directory
//simulate sending notifications with curl
//curl -X POST http://localhost:8080/send -d "fromID=2&toID=1&message=Mike started following you"
...
func setupProducer() (sarama.SyncProducer, error) {
	...
	config.Producer.Return.Successes = true //ensures producer receives ack once message is stored in topic
